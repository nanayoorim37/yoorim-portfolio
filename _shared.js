...
window.PROJECTS = [
  ...
  },
  {
    ...
    system:[['Main L/R','d&b Vi8 4ea + Vi12 2ea + Vi-SUB 1ea each'],['Front Fill','d&b Yi7P 2ea + Vi-GSUB 2ea each side'],['Under Balcony','d&b 8S 6ea'],['Stage Monitor','d&b MAX2 4ea + 5S 2ea + 8S 1ea'],['중고등부실','JBL VRX912 2ea + VRX918 2ea each side']],
    tasks:['기존 시스템 문제 진단: 메인 스피커 안쪽 배치로 인한 마이크-스피커 물리적 간섭 파악, 피드백 원인 규명','스피커 위치 재설계: 외측으로 이동해 마이크-스피커 간섭 물리적 해소','커버리지 보강 설계: 발코니 언더존 스피커 추가로 후방 데드존 해소','블록도 작성: 본당 Main L/R, Fills·MON, Under Balcony, 중고등부실, 유치부실 총 6개 작성','제안서 작성: 문제 진단·개선 방향·스피커 선정 근거 포함'],
